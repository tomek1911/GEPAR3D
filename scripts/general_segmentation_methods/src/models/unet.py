...
class UNet(nn.Module):
    ...
    def __init__(
        ...
        # #smoothing layer - eliminate checkerboard pattern
        self.model[2] = nn.Sequential(Convolution(spatial_dims, self.channels[0]*2, 1, self.strides[0], kernel_size, adn_ordering, None, None, is_transposed=True, bias=True),
                                      Convolution(spatial_dims, 1, 1, 1, kernel_size, adn_ordering, None, None, is_transposed=False, bias=False))
